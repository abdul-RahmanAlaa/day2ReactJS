      ...
      setErrors({
        ...
        confirmPasswordError:
          event.target.value.length === 0
            ...
            : event.target.value.length === user.password
    ...
    <div>
      <Form>
        ...
        <Form.Group className="mb-3">
          ...
          />
          <Form.Text className="text-warning">{error.userNameError}</Form.Text>
        </Form.Group>
        <Form.Group className="mb-3 toggler__parent">
          ...
          <Form.Text className="text-warning">{error.passwordError}</Form.Text>
        </Form.Group>
        <Form.Group className="mb-3 toggler__parent">
          <Form.Control
            type={type2}
